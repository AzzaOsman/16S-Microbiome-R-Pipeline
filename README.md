...
This repository contains microbiome data analysis performed during a workshop using river water samples. The analysis follows a standard 16S rRNA amplicon sequencing workflow in R, from sequence processing to community-level analysis.
